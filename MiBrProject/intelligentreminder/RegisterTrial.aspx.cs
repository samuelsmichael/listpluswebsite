...
public partial class RegisterTrial : InternetWebPage {
    ...
    void OutboundTraffic_Load(object sender, EventArgs e) {
        ...
        try {
            ...
            parms.Add(CommonMethods.buildStringParm("ccnbrparm",ccNbr,ParameterDirection.Input));
            ...
            CommonMethods.executeNonQuery("uspcreateregistration", parms, svm.SessionID);
            Response.Write("Ok");
        } catch (Exception eee) {
