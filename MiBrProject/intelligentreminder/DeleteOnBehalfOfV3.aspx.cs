...
public partial class DeleteOnBehalfOfV3 : InternetWebPage {
    public static string FD = "^~^";
    public DeleteOnBehalfOfV3() {
    ...
    void DeleteOnBehalfOf_Load(object sender, EventArgs e) {
        ...
        try {
            ...
            string foreignLocationId = getMeMyNextField(sr);
            ...
            parms2.Add(CommonMethods.buildUInt32Parm("foreignlocationidparm", Convert.ToInt32(foreignLocationId), ParameterDirection.Input));
            CommonMethods.executeNonQuery("uspdeleteonbehalfofv2", parms2, svm.SessionID);
            Response.Write("JeDisOk: foreignLocationId=" + foreignLocationId);
        } catch (Exception eee) {
