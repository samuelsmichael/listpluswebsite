<%@ Page MasterPageFile="~/intelligentreminder/Site1.Master" Language="C#" AutoEventWireup="true" CodeBehind="QuickStart.aspx.cs" Inherits="MiBrProject.QuickStart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>Just 3 easy steps!</h2>
                                <asp:Panel ID="PanelAddALocationControl" runat="server" CssClass="collapsePanelHeader" Height="30px">
                                    <div style="padding: 5px; cursor: pointer; vertical-align: middle;">
                                        ...
                                        <div style="float: right; vertical-align: middle;">
                                            <asp:ImageButton CausesValidation="False" ID="ImageAddALocationControl" runat="server" ImageUrl="~/intelligentreminder/images/expand_blue.jpg" AlternateText="(Show details...)" />
                                        </div>
                                    </div>
                                </asp:Panel>
                                <asp:Panel ID="PanelAddALocation" runat="server">
                                    ...
                                    <asp:Image ID="Image1" ImageUrl="~/intelligentreminder/images/AddALocation.JPG" Height="327" Width="190" ImageAlign="Left" runat="server" />
                                            </td>
                                            <td>
                                    ...
                                    <asp:Image ID="Image2" ImageUrl="~/intelligentreminder/images/UpdateALocation.JPG" Height="327" Width="322" ImageAlign="Right" runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                                <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" TargetControlID="PanelAddALocation"
                                    ...
                                    ExpandedImage="~/intelligentreminder/images/collapse_blue.jpg" CollapsedImage="~/images/expand_blue.jpg" Collapsed="true"
                                ...
                                <asp:Panel ID="PanelAddANeedControl" runat="server" CssClass="collapsePanelHeader" Height="30px">
                                    <div style="padding: 5px; cursor: pointer; vertical-align: middle;">
                                        ...
                                        <div style="float: right; vertical-align: middle;">
                                            <asp:ImageButton CausesValidation="False" ID="ImageAddANeedControl" runat="server" ImageUrl="~/intelligentreminder/images/expand_blue.jpg" AlternateText="(Show details...)" />
                                        </div>
                                    </div>
                                </asp:Panel>
                                <asp:Panel ID="PanelAddANeed" runat="server">
                                    <table cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="width:193px;">
                                    <asp:Image ID="ImageAddANeed" ImageUrl="~/intelligentreminder/images/AddANeed.JPG" Height="327" Width="190" ImageAlign="Left" runat="server" />
                                            </td>
                                            <td>
                                    <p class="quick-start-verbiage">
                                    At the Need tab, press Menu, and then Add Need.  Key in the Item, and optionally a description.  Press Work With Locations.  Again, don't forget to press Confirm when you're done.
                                            ...
                                            <td  style="width:193px;">
                                    <asp:Image ID="Image3" ImageUrl="~/intelligentreminder/images/UpdateANeed.JPG" Height="327" Width="190" ImageAlign="Right" runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                                ...
                                <asp:Panel ID="PanelAssociateANeedControl" runat="server" CssClass="collapsePanelHeader" Height="30px">
                                    <div style="padding: 5px; cursor: pointer; vertical-align: middle;">
                                        ...
                                        <div style="float: right; vertical-align: middle;">
                                            <asp:ImageButton CausesValidation="False" ID="ImageAssociateANeedControl" runat="server" ImageUrl="~/intelligentreminder/images/expand_blue.jpg" AlternateText="(Show details...)" />
                                        </div>
                                    </div>
                                </asp:Panel>
                                <asp:Panel ID="PanelAssociateANeed" runat="server">
                                    <table cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="width:193px;">
                                    <asp:Image ID="Image4" ImageUrl="~/intelligentreminder/images/AssociateNeedWithLocations.JPG" Height="327" Width="190" ImageAlign="Left" runat="server" />
                                            </td>
                                            <td>
                                    <p class="quick-start-verbiage">
                                    ...
                                    <table style="padding-top:25px;" cellpadding="5" cellspacing="5" border="0">
                                        <tr>
                                            <td>
                                    <asp:Image ID="Image5" ImageUrl="~/intelligentreminder/images/Notification1.JPG" Height="327" Width="190" ImageAlign="Left" runat="server" />
                                            </td>
                                            <td>
                                    <asp:Image ID="Image6" ImageUrl="~/intelligentreminder/images/Notification2.JPG" Height="327" Width="190" ImageAlign="Left" runat="server" />
                                            </td>
                                            <td>
                                    <asp:Image ID="Image7" ImageUrl="~/intelligentreminder/images/Notification3.JPG" Height="327" Width="190" ImageAlign="Left" runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
